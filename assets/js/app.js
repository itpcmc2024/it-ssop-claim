...
async function recordGeneratedZip(caseItem,fileName){
  ...
  return apiRequest('recordGeneratedSubmission',{Case_ID:caseItem.Case_ID,Period_Key:extractPeriodKeyFromName(fileName),Submission_File_Name:fileName,Generated_File_Name:fileName,updatedBy:'ZIP EDITOR'});
}
